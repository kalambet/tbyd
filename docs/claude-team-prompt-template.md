...
Teammate "ai-builder" should should implement the issue 2.9 from @docs/phase-2-user-surfaces.md. Use the ai-dev skill. They should be consulted about any AI decisions.
